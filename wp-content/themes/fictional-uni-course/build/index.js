...
class Search {
  constructor() {
    ...
    this.resultsContainer = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#search-overlay__results');
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(`${universityData.root_url}/wp-json/university/v1/search?q=${this.searchInput.val()}`, results => {
      this.resultsContainer.html(`
                <div class="row">
                    <div class="one-third">
